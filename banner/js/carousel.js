...
Carousel.prototype = {
    ...
    createDOM:function(container,options){
        ...
        for(var i = 0;i<imgLength;i++){
            $(".transverse-box").append("<div class='img-item'><a href='"+options.urls[0]+"' target='_blank'><img src='"+options.datas[i]+"'></a></div>");
        };
        $(".vertical-box ul").append("<li><a href='"+options.urls[1]+"' target='_blank'><img src='"+options.datas[1]+"'></a></li>");
        $(".vertical-box ul").append("<li><a href='"+options.urls[2]+"' target='_blank'><img src='"+options.datas[2]+"'></a></li>");
